...
# Hier wird der vorbereitete Thread genutzt
# Das klappt auch soweit, allerdings passiert durch den direkten Aufruf des Threads
# trotzdem nix, da muss ich wohl ein paar Infos raus schicken... -> Version h

class Berechnung(QThread):

    def run(self):
        print(self.berechnePiThready(10000000))

    def berechnePiThready(self,n):
        pi_halbe=1
