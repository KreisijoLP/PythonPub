...
# b: systematische Auflistung der verschiedenen Varianten
#      V1: Textdatei zeilenweise
#      V2: Textdatei in eine Liste
#      V3: Textdatei in einen(!) String
...
# Text (V2=Liste, V3=String) in QPlainTextEditor
